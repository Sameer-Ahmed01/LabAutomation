                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown country-selector d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                    ...
                                    <a class="dropdown-item d-flex" href="login-1.php">
                            ...
                            <div class="dropdown profile-dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                    <div class="text-center">
                                        <div class="text-center user pb-0 font-weight-bold"><?php if(isset($_SESSION["UserFullName"])) { echo $_SESSION["UserFullName"]; } ?></div>
                                        <span class="text-center user-semi-title"><?php echo "Designation"; ?></span>
